...
export class SourcesController {
   ...
   */
  getByBrandId = asyncHandler(async (req: Request, res: Response) => {
    const { brandId } = req.params;

    const sources = await this.service.getByBrandId(brandId);

    return success(res, sources, 'Sources récupérées avec succès');
  });
  ...
  getById = asyncHandler(async (req: Request, res: Response) => {
    ...
    return success(res, source, 'Source récupérée avec succès');
  });
  ...
  create = asyncHandler(async (req: Request, res: Response) => {
    ...
    return success(res, source, 'Source créée avec succès', 201);
  });
  ...
  update = asyncHandler(async (req: Request, res: Response) => {
    ...
    return success(res, source, 'Source mise à jour avec succès');
  });
  ...
  delete = asyncHandler(async (req: Request, res: Response) => {
    ...
    return success(res, null, 'Source supprimée avec succès');
  });
  ...
  updateStatus = asyncHandler(async (req: Request, res: Response) => {
    ...
    return success(res, source, 'Statut mis à jour avec succès');
  });

  /**
   * Déclencher un scraping manuel
   */
  triggerScraping = asyncHandler(async (req: Request, res: Response) => {
    const { sourceId } = req.params;

    const result = await this.service.triggerScraping(sourceId);

    return success(res, result, 'Scraping déclenché avec succès');
  });
}
