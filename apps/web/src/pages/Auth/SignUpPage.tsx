...
export default function SignUpPage() {
  ...
  const [formData, setFormData] = useState({
    organisation: 'X_AE_A_13b',
    name: 'HOPE Alexanders',
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" 
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8">
        ...
        {/* Title */}
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Sign Up For Free.</h1>
        <p className="text-gray-500 mb-8">Unleash your inner sloth 4.0 right now.</p>
        ...
        <form className="space-y-5">
          ...
          <div>
            ...
            <div className="mt-2">
              ...
              <p className="text-xs text-gray-600">Password strength: Strong</p>
            </div>
          </div>
          ...
          <button
            type="submit"
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 rounded-xl transition duration-200 flex items-center justify-center gap-2 shadow-lg"
          >
            Sign Up
