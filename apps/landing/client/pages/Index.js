    ...
    return (<div className="min-h-screen bg-white">
      ...
      <nav className="px-6 md:px-[100px] py-5 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-10">
          ...
          <button_1.Button className="rounded-[14px] bg-brand-blue text-white px-9 py-5 text-lg h-auto font-space font-normal hover:bg-brand-blue/90">
            Demander une démo
          </button_1.Button>
        </div>
      </nav>
        ...
        <div className="max-w-[1240px] mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <button_1.Button className="rounded-[14px] bg-brand-blue text-white px-9 py-6 text-lg h-auto font-space font-normal hover:bg-brand-blue/90">
                Demander une démo
              </button_1.Button>
              <button_1.Button variant="outline" className="rounded-[14px] border-brand-dark px-9 py-6 text-lg h-auto font-space font-normal hover:bg-brand-grey">
        ...
        <div className="max-w-[1240px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-[45px] p-10 border border-brand-dark shadow-[0_5px_0_0_#191A23]">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-2">
                  <lucide_react_1.Check className="w-5 h-5 text-brand-green flex-shrink-0 mt-0.5"/>
                  <span className="font-space">Surveillance basique</span>
                </li>
                <li className="flex items-start gap-2">
                  <lucide_react_1.Check className="w-5 h-5 text-brand-blue flex-shrink-0 mt-0.5"/>
              ...
              <button_1.Button className="w-full rounded-[14px] border-brand-dark bg-white hover:bg-brand-grey text-brand-dark border px-9 py-6 text-lg h-auto font-space font-normal">
                Commencer
              </button_1.Button>
            ...
            <div className="bg-brand-blue rounded-[45px] p-10 border-2 border-brand-dark shadow-[0_5px_0_0_#191A23] relative">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-2">
                  <lucide_react_1.Check className="w-5 h-5 text-white flex-shrink-0 mt-0.5"/>
                  <span className="font-space">Surveillance étendue</span>
                </li>
                <li className="flex items-start gap-2">
                  <lucide_react_1.Check className="w-5 h-5 text-brand-dark flex-shrink-0 mt-0.5"/>
              ...
              <button_1.Button className="w-full rounded-[14px] bg-white hover:bg-white/90 text-brand-blue px-9 py-6 text-lg h-auto font-space font-normal">
                Commencer
              </button_1.Button>
          ...
          <div className="bg-brand-grey rounded-[45px] p-12 md:p-16 border border-brand-dark relative overflow-hidden">
            <div className="relative z-10 max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button_1.Button variant="outline" className="rounded-[14px] border-brand-dark px-9 py-6 text-lg h-auto font-space font-normal hover:bg-white">
                  Planifier une démo
                </button_1.Button>
              </div>
            </div>
        ...
        <div className="max-w-[1240px] mx-auto">
          ...
          <div className="bg-white rounded-[45px] p-10 md:p-12 border border-brand-dark">
            <form className="space-y-8 max-w-2xl">
              <radio_group_1.RadioGroup defaultValue="demo" className="flex gap-8">
                <div className="flex items-center space-x-3">
                  <radio_group_1.RadioGroupItem value="demo" id="demo" className="border-brand-dark"/>
                  <label_1.Label htmlFor="demo" className="font-space text-lg cursor-pointer">Demander une démo</label_1.Label>
                </div>
                <div className="flex items-center space-x-3">
                  <radio_group_1.RadioGroupItem value="quote" id="quote" className="border-brand-dark"/>
                  <label_1.Label htmlFor="quote" className="font-space text-lg cursor-pointer">Obtenir un devis</label_1.Label>
                </div>
              </radio_group_1.RadioGroup>

              <div className="space-y-2">
                <label_1.Label htmlFor="name" className="font-space">Nom</label_1.Label>
                <input_1.Input id="name" placeholder="Votre nom" className="rounded-[14px] border-brand-dark h-14 font-space"/>
              </div>

              <div className="space-y-2">
                <label_1.Label htmlFor="email" className="font-space">Email*</label_1.Label>
                <input_1.Input id="email" type="email" placeholder="votre@email.com" className="rounded-[14px] border-brand-dark h-14 font-space" required/>
              </div>

              <div className="space-y-2">
                <label_1.Label htmlFor="message" className="font-space">Message*</label_1.Label>
                <textarea_1.Textarea id="message" placeholder="Parlez-nous de vos besoins..." className="rounded-[14px] border-brand-dark min-h-[150px] font-space" required/>
              </div>

              <button_1.Button className="w-full rounded-[14px] bg-brand-dark text-white px-9 py-6 text-lg h-auto font-space font-normal hover:bg-brand-dark/90">
                Envoyer le message
              </button_1.Button>
            </form>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input_1.Input placeholder="Votre email" className="rounded-[14px] bg-brand-dark border-white/30 text-white placeholder:text-white/50 font-space"/>
                <button_1.Button className="rounded-[14px] bg-brand-blue text-white hover:bg-brand-blue/90 font-space px-6">
                  →
                </button_1.Button>
              </div>
            </div>
